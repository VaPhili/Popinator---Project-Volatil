function amount_statistic(data,path,filtertext)
    ...
    % export data (header)
    fileout_data = "Statistic"+filtertext+"_Amount_All.txt";
    ...
    for n = 1:datasets
        ...
        stats{temp,mat,rate} = [stats{temp,mat,rate}, size(data{n,2},1)]; 

        % export to file
        fprintf(fid,'%6d %8s         %3d       %2.2f  %5s \n',size(data{n,2},1), data{n,1}{1,1}, data{n,1}{1,2}, rate, data{n,1}{1,4}); 
    end
    ...
    %layoutpositions = [
    %    0/6 5/6 1/6 1/6; 1/6 5/6 1/6 1/6; 2/6 5/6 1/6 1/6; 3/6 5/6 1/6 1/6; 4/6 5/6 1/6 1/6; 5/6 5/6 1/6 1/6;
    %    0/6 4/6 1/6 1/6; 1/6 4/6 1/6 1/6; 2/6 4/6 1/6 1/6; 3/6 4/6 1/6 1/6; 4/6 4/6 1/6 1/6; 5/6 4/6 1/6 1/6;
    %    0/6 3/6 1/6 1/6; 1/6 3/6 1/6 1/6; 2/6 3/6 1/6 1/6; 3/6 3/6 1/6 1/6; 4/6 3/6 1/6 1/6; 5/6 3/6 1/6 1/6;
    %    0/6 2/6 1/6 1/6; 1/6 2/6 1/6 1/6; 2/6 2/6 1/6 1/6; 3/6 2/6 1/6 1/6; 4/6 2/6 1/6 1/6; 5/6 2/6 1/6 1/6;
    %    0/6 1/6 1/6 1/6; 1/6 1/6 1/6 1/6; 2/6 1/6 1/6 1/6; 3/6 1/6 1/6 1/6; 4/6 1/6 1/6 1/6; 5/6 1/6 1/6 1/6;
    %    0/6 0/6 1/6 1/6; 1/6 0/6 1/6 1/6; 2/6 0/6 1/6 1/6; 3/6 0/6 1/6 1/6; 4/6 0/6 1/6 1/6; 5/6 0/6 1/6 1/6;
    %];
    hold on;

    fileout_avg = "Statistic"+filtertext+"_Amount_Average.txt";
    ...
    for temp = 1:size(temperatures,1)
        for mat = 1:size(materials,1)
            ...
            for rate = 1:size(stats,3)
                tmp_amount = stats{temp, mat, rate};
                tmp_rate = rates(rate) * ones(size(tmp_amount(:)));
                tmp = [tmp; [tmp_rate, tmp_amount(:)]];
            end
    ...
    fileout_graph = "Statistic"+filtertext+"_Amount.png";
